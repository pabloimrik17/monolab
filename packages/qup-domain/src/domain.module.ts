...
import { GetActiveSessionsUseCase } from "./use-cases/get-active-sessions.use-case.ts";
...
import { GetSessionByIdUseCase } from "./use-cases/get-session-by-id.use-case.ts";
...
export const domainModule = new ContainerModule(({ bind }) => {
    ...
    bind(TOKENS.GetSessionByIdUseCase).to(GetSessionByIdUseCase);
    bind(TOKENS.GetActiveSessionsUseCase).to(GetActiveSessionsUseCase);

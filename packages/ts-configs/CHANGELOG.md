...
## [1.0.2](https://github.com/pabloimrik17/monolab/compare/ts-configs-v1.0.1...ts-configs-v1.0.2) (2025-11-09)
...
## [0.4.0](https://github.com/pabloimrik17/monolab/compare/ts-configs-v0.3.4...ts-configs-v0.4.0) (2025-11-08)
...
-   TypeScript configuration packages for Node.js and Web projects
-   Base configurations with strict type checking
-   Application and library specific configurations

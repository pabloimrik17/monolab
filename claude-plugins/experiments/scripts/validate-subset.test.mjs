...
test("tokenizeSelection splits on commas outside quotes", () => {
    assert.deepEqual(tokenizeSelection('react, "react: useTransition, non-urgent", zod'), [
        "react",
        "react: useTransition, non-urgent",
        "zod",
    ]);
...
test("improvement tokens match by case-insensitive substring", () => {
    ...
    assert.deepEqual(result.improvementMatches[0].matchedTitles, [

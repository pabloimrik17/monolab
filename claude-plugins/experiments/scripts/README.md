...
| `validate-subset.mjs`        | Deterministic `pick-subset` parsing: exact-match bump exclusions, substring-match improvement exclusions, unmatched tokens flagged for re-prompt.                                                                                                                                                                                                                                |

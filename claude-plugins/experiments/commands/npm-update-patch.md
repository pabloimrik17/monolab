...
The command **only bumps manifests and runs a single install**; it never creates commits autonomously. The final summary suggests verification and commit as next steps; the caller decides.

...
The system SHALL define a `plantas_venta` table: `id` (UUID PK), `planta_id` (UUID FK→plantas, NOT NULL), `identificador` (INTEGER, NOT NULL), `fotos` (JSONB, DEFAULT '[]'), `alto_planta_cm` (NUMERIC(10,2), NOT NULL), `maceta_id` (UUID FK→macetas, NOT NULL), `sustrato_id` (UUID FK→sustratos, NOT NULL), `coste_planta` (NUMERIC(10,2), nullable).

...
Codecov MUST support separate coverage tracking for each package in the monorepo.
...
**Then** each package is tagged with a flag (e.g., `react-hooks`, `react-clean`, `is-even`)

...
- **Affected code**:
  - `packages/types/src/string-keyof.ts` (new file)
  - `packages/types/src/string-keyof.test-d.ts` (new file)
  - `packages/types/src/index.ts` (export addition)

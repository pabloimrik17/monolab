# npm-changelog-caching Specification

## Purpose

Local file-system caching layer for npm package changelogs, providing persistent storage, TTL-based freshness, and integrity verification via SHA256 checksums.

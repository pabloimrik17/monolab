# expo-developer-plugin Specification

## Purpose

Claude Code plugin that supports Expo project developers with skills for validating dependencies and surfacing developer-experience tooling. Honors user-configurable behavior so contributors can tune default actions and override package-manager detection.
